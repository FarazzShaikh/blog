...
This library provides many popular noise function definitions. It also provides loaders which automatically append them to the start of our shaders! We will use the `loadShadersCSM` loader from `gl-noise`.
