...
You can set the resolution of the `IcosahedronGeometry` to `138` to get ~1M vertices and as promised, [here is a demo](https://farazzshaikh.github.io/experiments/index.html?src=/Particles/1M%20Particles/index.html) to a simulation with 1 million particles.
