  ...
  return (
    <footer className="has-nice-link no-print">
      <div className="footer-container">
        ...
        <div className="socials-container" style={{ display: "flex", flexDirection: "column", flex: 1 }}>
          <h1 className="title is-4 mb-0">Hire me</h1>
          ...
          <h1 className="title is-4 mb-0">Support me</h1>
          ...
          <h1 className="title is-4 mb-0">Follow me</h1>
          <div className="column">
